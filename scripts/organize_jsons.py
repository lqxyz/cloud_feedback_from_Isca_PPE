...
# Put its elements in a more natural order (e.g., Tropical marine
# low cloud amount = region/sfc/sec/name)
        ...
        for sfc in ['all', 'ocn', 'lnd', 'ocn_asc', 'ocn_dsc']:
            ...
            for sec in ['ALL', 'HI680', 'LO680']:
                ...
                for name in names:
                    ...
                    old_dict[mo][ripf][region][sfc][sec]['NET'+name] = new_dict[sec]['LW'+name][region][sfc] + \
                                                                       new_dict[sec]['SW'+name][region][sfc]
                # end name loop
            # end section loop
        # end sfc type loop
    # end region loop
